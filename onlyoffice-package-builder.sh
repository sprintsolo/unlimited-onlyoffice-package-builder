...
CORE_CUSTOM_COMMITS="70730dd538c4c6494c3ab6fc5f73724767295178 22966ce3c676b2b72aa88c76da1af2ab9e44b522 4252575f7beb1c8a6ccd11e0fdf0334f16dd5d30 d38ca3e65dadcead5dca9e94f21ef2cab80fc745 18823efb317b7b1494249f4ba97c49aad007b541 3e343a55836575d8ae7be389dacc109f059308ec 95eb3fef5496532f87f8a590864b269ae9c08b51 b93b99c82cc3f1cde64095ed826391789def17f8 6a854c019e8a3a3e30672ef46b62ee13f18affd2 34c48003983e2dcbe57360b1f602c0688ccc3f56 7de5ef4ff0cc8135234072b2517b3ec0f13fde68 4943540fa4a09cdcd1824c72d9114354151477bd dd3acc54d61da78222ff713d7ead71f36a7272b0 bf455c0dbe9b983198e5613e5fc0144832049c9b 4d3afe017acb55c02d7fb41a8ef77c406dd9539d"
...
build_oo_binaries() {
  ...
  docker run -e PRODUCT_VERSION=${_PRODUCT_VERSION} -e BUILD_NUMBER=${_BUILD_NUMBER} -e NODE_ENV='production' -e GCLIENT_SHALLOW=1 -v $(pwd)/${_OUT_FOLDER}:/build_tools/out -v $(pwd)/../server:/server -v $(pwd)/../web-apps:/web-apps -v $(pwd)/../core:/core onlyoffice-document-editors-builder /bin/bash -c '\
    ...
    for attempt in 1 2 3; do \
      python3 ./automate.py --branch=tags/'"${_UPSTREAM_TAG}"' && build_ok=true && break; \
    ...
    if [ "$build_ok" != "true" ]; then echo "All 3 build attempts failed"; exit 1; fi'
  cd ..
